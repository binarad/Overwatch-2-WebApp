...
function Card() {
    ...
    const [heroOption, setHeroOption] = useState<SelectOptions | undefined> (undefined)
    const data: HeroType[] | null = useFetch<HeroType[]>('https://overfast-api.tekrop.fr/heroes')
    useEffect(() => {
        if(heroOption && data) {
